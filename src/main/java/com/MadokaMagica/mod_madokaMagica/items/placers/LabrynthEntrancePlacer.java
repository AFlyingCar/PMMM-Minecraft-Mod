...
public class LabrynthEntrancePlacer extends ItemMonsterPlacer {
    ...
    public LabrynthEntrancePlacer(){
        super();
    }

    public LabrynthEntrancePlacer(String entitySpawnName, int colorBack, int colorSpot){
