...
public class IncubatorMonsterPlacer extends ItemMonsterPlacer {
    @SideOnly(Side.CLIENT)
    private IIcon icon;
    protected int colorBack = 0xFFFFFF;
    protected int colorSpot = 0xFF0000;
    protected String entitySpawnName = "";
    protected String entitySpawnNameFull = "";
    protected EntityLiving entity = null;

    public IncubatorMonsterPlacer(){
        super();
    }

    public IncubatorMonsterPlacer(String entitySpawnName, int colorBack, int colorSpot){
        setHasSubtypes(false);
        maxStackSize = 64;
        setCreativeTab(CreativeTabs.tabMisc);
        setEntitySpawnName(entitySpawnName);
    ...
    public Entity spawnEntity(World world, double x, double y, double z){
        if(!world.isRemote){
            entitySpawnNameFull = MadokaMagicaMod.MODID+"."+entitySpawnName;
            if(EntityList.stringToClassMapping.containsKey(entitySpawnNameFull)){
                entity = (EntityLiving)EntityList.createEntityByName(entitySpawnNameFull,world);
                entity.setLocationAndAngles(x,y,z,MathHelper.wrapAngleTo180_float(world.rand.nextFloat()*360.0F),0.0F);
                world.spawnEntityInWorld(entity);
                entity.onSpawnWithEgg((IEntityLivingData)null);
                entity.playLivingSound();
            }else{
                System.out.println("Unable to find entity " + entitySpawnNameFull + "!");
            }
        }
    ...
    public void setEntitySpawnName(String entitySpawnName){
        ...
        this.entitySpawnNameFull = MadokaMagicaMod.MODID+"."+this.entitySpawnName; 
    }
}
